                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('member.update',$member->id); }}" method="POST">  
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="nama" class="form-control" id="nama" aria-describedby="emailHelp" value="{{ $member->nama }}" required>
                        </div>
                        <div class="mb-3">
                          <label for="tinggibadan" class="form-label">Tinggi Badan : </label>
                          <input type="text" name="tinggibadan" class="form-control" id="tinggibadan"  value="{{ $member->tinggiBadan }}" required>
                        </div>
                        <div class="mb-3">
                          <label for="beratbadan" class="form-label">Berat Badan : </label>
                          <input type="text" name="beratbadan" class="form-control" id="beratbadan" value="{{ $member->beratBadan }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="tahunlahir" class="form-label">Tahun Lahir : </label>
                            <input type="year" name="tahunlahir" class="form-control" id="tahunlahir"  value="{{ $arr['umur'] }}" required>
                         </div>
                        <div class="mb-3">
                            <label for="hobi" class="form-label">Hobi : <span class="text-danger">*MINIMAL 3 HOBI</span></label>
                            <br>
                            <label for="" class="fst-italic text-danger">Hobi 1</label>
                            <input type="text" name="hobi[]" class="form-control" id="hobi"  value="{{ $hobi['datahobi'][0] }}" required>
                            <br>
                            <label for="" class="fst-italic text-danger">Hobi 2</label>
                            <input type="text" name="hobi[]" class="form-control" id="hobi"  value="{{ $hobi['datahobi'][1] }}" required>
                            <br>
                            <label for="" class="fst-italic text-danger">Hobi 3</label>
                            <input type="text" name="hobi[]" class="form-control" id="hobi" value="{{ $hobi['datahobi'][2] }}" required>
                         </div>
